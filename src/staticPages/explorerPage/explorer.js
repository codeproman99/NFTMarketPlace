...
import { avatar, featureItem1 } from "../../img";
            ...
            <div className="primary-content-area container content-padding">
                <div className="page-title-section">
                    ...
                    <div className="display-mode-links">
                        <a href="#/"><svg className="crumina-icon">
                            <use xlinkHref="#big-grid-icon"></use>
                        </svg></a>
                        <a href="#/"><svg className="crumina-icon">
                            <use xlinkHref="#small-grid-icon"></use>
                        </svg></a>
                    </div>
                </div>
                ...
                <div className="categories-bar">
                    <div className="categories-nav">
                        <a href="#/" className="arrow arrow-left swiper-button-prev"><svg className="crumina-icon"><use xlinkHref="#arrow-left2-icon"></use></svg></a>
                        <a href="#/" className="arrow arrow-right swiper-button-next"><svg className="crumina-icon"><use xlinkHref="#arrow-right2-icon"></use></svg></a>
                    </div>
                    <div className="categories-wrapper swiper-wrapper">
                        <div className="category-item swiper-slide"><a href="#/"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 15">
                            <defs />
                        ...
                        <div className="category-item swiper-slide"><a href="#/"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 13">
                            <defs />
                        ...
                        <div className="category-item swiper-slide"><a href="#/"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 14">
                            <defs />
                        ...
                        <div className="category-item swiper-slide"><a href="#/"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 12 16">
                            <defs />
                        ...
                        <div className="category-item swiper-slide"><a href="#/"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 12">
                            <defs />
                        ...
                        <div className="category-item swiper-slide"><a href="#/"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 11">
                            <defs />
                        ...
                        <div className="category-item swiper-slide"><a href="#/">
                ...
                <div className="filterable-bar">
                    <form id="artworks-filter-form">
                        ...
                        <div className="filter-item">
                            <select className="select-nice" value="auctions-only">
                        ...
                        <div className="filter-item">
                            <select className="select-nice" value={`verified-creators`}>
